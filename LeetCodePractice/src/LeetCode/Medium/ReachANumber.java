...
public class ReachANumber {
     ...
     * Step 1: Find the smallest step that the summation from 1 to step just exceeds or equals to target.
     ...
     * Step 2: Difference = 6 - 5 = 1. Since the difference is an odd value, we will not reach the target by switching
     *         any right move to the left. So we increase our step.
     ...
     *         We can do 1 - 2 - 3 + 4 + 5 = 5 to reach target. We take our first step to the right,
     *         then second step to the left, etc etc you get the idea.
     *
     * @param target
     * @return
     */
