...
/**
 * Given a non-empty array of numbers, a0, a1, a2, ¡­ , an-1, where 0 ¡Ü ai < 2^31.
 * 
 * Find the maximum result of ai XOR aj, where 0 ¡Ü i, j < n. Could you do this in O(n) runtime?
 * 
