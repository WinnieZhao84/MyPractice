...
public class OpenTheLock {
    ...
    public int openLock(String[] deadends, String target) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i=0; i<size; i++) {
                ...
                if (visited.add(cur) && !deadendList.contains(cur)) {

                    List<String> nextStrs = this.getNextResults(cur);
                    queue.addAll(nextStrs);
                }
            }
            step++;
        }
    ...
    private List<String> getNextResults(String cur) {
        ...
        for (int i=0; i<chars.length; i++) {
            ...
            chars[i] = oldCh;
            chars[i] = (char) ((chars[i] - '0' - 1 < 0 ? chars[i] - '0' + 9 : chars[i] - '0' - 1) % 10 + '0');
            res.add(String.valueOf(chars));
            chars[i] = oldCh;
        }
