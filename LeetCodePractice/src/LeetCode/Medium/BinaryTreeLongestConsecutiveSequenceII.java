 ...
 * but the path [1,2,4,3] is not valid. On the other hand, the path can be in the child-Parent-child order, where not necessarily
...
public class BinaryTreeLongestConsecutiveSequenceII {
    ...
    public int[] longestPath(TreeNode root) {
        ...
        if (root.left != null) {
            int[] l = this.longestPath(root.left);
        ...
        if (root.right != null) {
            int[] r = this.longestPath(root.right);
