...
public class BrickWall {
    ...
    public static void main(String[] args) {
        ...
        wall.add(Arrays.asList(a1));
        wall.add(Arrays.asList(a2));
        wall.add(Arrays.asList(a3));
        wall.add(Arrays.asList(a4));
        wall.add(Arrays.asList(a5));
        wall.add(Arrays.asList(a6));
