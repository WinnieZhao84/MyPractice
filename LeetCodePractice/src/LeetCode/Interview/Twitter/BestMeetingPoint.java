 ...
 * distance of 2+2+2=6 is minimal.
 * So return 6.
 *
 */
public class BestMeetingPoint {
    ...
    public int minTotalDistance(int[][] grid) {
         ...
         * 如果起点是1，2和4，那2->3和1->2->3这两条路径就有重复了。为了尽量保证右边的点向左走，
         * 左边的点向右走，那我们就应该去这些点中间的点作为交点。
         * 由于是曼哈顿距离，我们可以分开计算横坐标和纵坐标，结果是一样的。所以我们算出各个横坐标到中点横坐标的距离，
         * 加上各个纵坐标到中点纵坐标的距离，就是结果了
         *
         */
        // 统计出有哪些横纵坐标
