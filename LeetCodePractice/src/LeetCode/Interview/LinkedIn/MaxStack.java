 ...
 *
 * Created by WinnieZhao on 12/24/2017.
 */
public class MaxStack {
     ...
     *
     * Say we have a double linked list as our "stack". This reduces the problem to finding which node to remove,
     ...
     */
    class MaxStack_better {
        TreeMap<Integer, List<Node>> map;
        DoubleLinkedList dll;

        public MaxStack_better() {
            map = new TreeMap();
