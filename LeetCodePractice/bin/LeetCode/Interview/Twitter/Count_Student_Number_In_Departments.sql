 ...
 *
 * Sort your results by descending number of students; if two or more departments have the same number
 * of students, then sort those departments alphabetically by department name.
 *
 ...
 * Created by WinnieZhao on 1/14/2018.
 */
